...
The rose-wreathed crescent moon and star sits in the midground band,
...
Centred beneath, in order with generous spacing:
  ...
  a short paragraph of ceremony text, three to four lines of body copy [walimahBody]
...
Confirmed props for this section (spec/assets.json) — no others may appear:
  ...
  - Dusty blue-grey rose bloom — band: foreground-frame, 0.8x anchor (prop)
  - Rose-wreathed crescent moon and star — band: midground, 0.7x anchor (icon)

Geometry (spec/scene.json): scale anchor = a fully-open rose bloom at
18% of frame height at band multiplier 1.0;
bands {"background": 2.2, "midground": 1.0, "foreground-frame": 1.4}; reserved content zone [30, 70]%.
