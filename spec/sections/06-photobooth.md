...
The floral-corner picture frame sits in the midground band, horizontally
...
Centred beneath, in order with generous spacing:
  a photo booth block: a grid of guest photo thumbnails with an upload button beneath it [photoBooth]
...
Confirmed props for this section (spec/assets.json) — no others may appear:
  ...
  - Small bird silhouette — band: midground, 0.25x anchor (prop)
  - Floral-corner picture frame — band: midground, 0.7x anchor (icon)

Geometry (spec/scene.json): scale anchor = a fully-open rose bloom at
18% of frame height at band multiplier 1.0;
bands {"background": 2.2, "midground": 1.0, "foreground-frame": 1.4}; reserved content zone [23, 69]%.
