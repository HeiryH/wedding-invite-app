...
The open scroll with a feather quill sits in the midground band, horizontally
...
Confirmed props for this section (spec/assets.json) — no others may appear:
  ...
  - Open scroll with a feather quill — band: midground, 0.6x anchor (icon)

Geometry (spec/scene.json): scale anchor = a fully-open rose bloom at
18% of frame height at band multiplier 1.0;
bands {"background": 2.2, "midground": 1.0, "foreground-frame": 1.4}; reserved content zone [34, 78]%.
