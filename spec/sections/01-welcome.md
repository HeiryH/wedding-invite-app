...
The floral arch silhouette occupies the background band: its crown spans
...
Centred beneath, in order with generous spacing:
  ...
  Dewan Perdana, Kuala Lumpur / 11:00 AM – 4:00 PM — body text, two lines [ceremonyDetails]
...
Confirmed props for this section (spec/assets.json) — no others may appear:
  ...
  - Floral arch silhouette — band: background, 1.8x anchor (scenery)

Geometry (spec/scene.json): scale anchor = a fully-open rose bloom at
18% of frame height at band multiplier 1.0;
bands {"background": 2.2, "midground": 1.0, "foreground-frame": 1.4}; reserved content zone [19, 61]%.
