...
namespace WeddingInvite.Core.Services
{
    public interface IWeddingService
    {
        ...
        Task<IEnumerable<WeddingDto>> GetByCreatorAsync(int userId);
        Task<WeddingDto> CreateAsync(CreateWeddingDto createDto, int? createdByUserId = null);
        ...
        Task<WeddingDto?> GetByDomainAsync(string domain);
